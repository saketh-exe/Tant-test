...
function EventCard() {
  ...
  return (
    <div className="w-[250px] h-[350px] bg-white rounded-[10px] flex flex-col justify-start p-[20px] gap-[10px] hover:scale-105 duration-200">
      ...
      <div className="flex flex-col items-center">
        <h3 className="text-[20px] font-bold text-black mt-2 hover:text-[#1d4ed8] transition-colors duration-300">
          {event.title}
        </h3>
        {/* <p className="text-[14px] max-w-[200px] font-normal text-[#4a4a4a] mt-1 truncate">
          {event.description}
        </p> */}

        <div className="mt-[10px] text-[14px] text-[#323232] flex flex-col items-start gap-[5px]">
          <p className="text-sm">
            <strong className="font-bold text-[#000000]">Date:</strong>{" "}
