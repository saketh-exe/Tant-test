          ...
          <div className="flex justify-center items-center">
            <div className="bg-accom_card_bg p-6 rounded-lg shadow-lg w-3/4">
              ...
              <p className="text-sm mb-4 text-justify">
                ...
                during the course of the fest, contact,
              </p>
              <div className="grid grid-cols-2 gap-4 text-sm font-medium">
                <div className="text-black text-sm font-medium bg-phone_bg p-3 rounded-lg">
                  <p>BOYS</p>
                  <p className="font-semibold mt-2">Ph: +91 123456789</p>
                </div>
                <div className="text-black text-sm font-medium bg-phone_bg p-3 rounded-lg">
                  <p>GIRLS</p>
                  <p className="font-semibold mt-2">Ph: +91 123456789</p>
              ...
              <div className="bg-blue-100 text-blue-900 p-4 mt-4 rounded-lg text-xs font-semibold">
          ...
          <div className="flex justify-center items-center">
            <div className="bg-accom_card_bg p-6 rounded-lg shadow-lg w-3/4">
              ...
              <p className="text-sm mb-4 text-justify">
                ...
                transport during the course of the fest, contact,
              </p>
              <div className="text-black text-sm font-medium bg-phone_bg p-3 rounded-lg">
